...
Anthropic provider calls: 23 successful, 4 rejected at zero reported usage. R7's two local-fixture
...
replay remains blocked until the invalid configured credential is replaced. One controlled validity
recheck after exact-head CI returned the same rejection with zero usage; no further retry was made.
