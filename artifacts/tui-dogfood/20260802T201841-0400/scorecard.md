...
Warden-heavy and R2 feature-workflow changes raises that aggregate to **3.10/5**. This is a meaningful
truth/recovery gain, not the 3.8 release gate: responsiveness, progress visibility, mutation review,
long-task runway, resume/history, and command-detail ranking remain unresolved.
